			...
			<section class="slider">
				<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    if($dbh){
                        ...
                        foreach($row as $val){
                    ?>
						<div class="carousel-item <?php if($val['id'] == 10) echo 'active';?>">
			...
			<section class="courses">
				<div class="container">
					...
					<div class="owl-carousel owl-theme">
						...
						<div class="item">
							<div class="card">
								<img class="card-img-top" src="assets/img/class.png" alt="Card image cap">
								<div class="card-body">
									...
									<p class="card-text text-center">Vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto.</p>
									<ul class="list d-flex justify-content-between">
										<li class="list-item">
											<i class="fa fa-user"></i> 300
										</li>
										<li class="list-item">APPLY NOW</li>
										<li class="list-item"> $500</li>
									</ul>
								</div>
							</div>
						</div>
						...
						<div class="item">
							<div class="card">
								<img class="card-img-top" src="assets/img/Cource.png" alt="Card image cap">
								<div class="card-body">
									<h5 class="card-title text-center">The Art of Photography</h5>
									<p class="text-center">by <span class="first_color">Joseph Langdon</span></p>
									<p class="card_border"></p>
						...
						<div class="item">
							<div class="card">
								<img class="card-img-top" src="assets/img/cource2.png" alt="Card image cap">
								<div class="card-body">
									<h5 class="card-title text-center">The Art of Photography</h5>
									<p class="text-center">by <span class="first_color">Joseph Langdon</span></p>
									<p class="card_border"></p>
