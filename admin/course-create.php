...
if(isset($_POST['submit'])){
   ...
   */
  $sql = 'INSERT INTO `course`( `name`, `date`, `course_duration`, `class_duration`, `seat_available`,
   `class_size`, `course_price`,  `short_description`, `long_description`, `teacer_id`, `image`,`status`) VALUES
   (?,?,?,?,?,?,?,?,?,?,?,?)';
  /*
   * Prepare Statement
   */
  ...
  $stmt->bindParam(8, $_POST['short_description']);
  $stmt->bindParam(9, $_POST['long_description']);
  $stmt->bindParam(10, $_POST['teacer_id']);
          ...
          <div class="tile">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="long_description" id="long_description">
                </div>
                <div class="form-group">
                  <label class="control-label" for="teacer_id">Teacher id</label>
                  <input class="form-control" type="text" name="teacer_id" id="teacer_id">
                </div>
                <div class="form-group">
            ...
            <div class="tile-footer">
              <button class="btn btn-primary" type="submit" name="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Add Course</button>
              &nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="course-show.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
            </div>
            </form>
          </div>
        </div>
