        ...
        <div class="col-md-6 m-auto">
          <div class="tile">
            ...
            <form action="course-update.php" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" name="id" value="<?php echo $id ?>">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="teacer_id" id="teacer_id" value="<?php echo $teacer_id; ?>">
                  </div>
                <div class="form-group">
            ...
            <div class="tile-footer">
              <button class="btn btn-primary" type="submit" name="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Update Slide</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary" href="course-show.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
            </div>
            </form>
          </div>
        </div>
